...
user-create-name-placeholder = First and last name
...
user-edit-name-placeholder = First and last name
...
profile-name-placeholder = First and last name
profile-submit = Save
...
password-error-too-few-digits = Password must contain at least two digits
password-error-too-few-special = Password must contain at least two special characters
