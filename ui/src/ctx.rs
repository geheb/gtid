...
use gtid_shared::i18n::I18n;
use gtid_shared::entities::{client::Client, email_template::EmailTemplate, user::User};
...
pub struct LegalListCtx<'a> {
    ...
    pub active_page: &'a str,
    pub csrf_token: &'a str,
    pub pages: &'a [gtid_shared::entities::legal_page::LegalPage],
    pub supported_langs: &'a [&'a str],
}
