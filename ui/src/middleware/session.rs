// scope: ui — SessionUser/AdminUser + trust-device cookie are UI-only (API is stateless JWT)
...
use gtid_shared::entities::user::User;
use gtid_shared::errors::AppError;

use crate::handlers::redirect;

// Cookies
pub const SESSION_ID_COOKIE_NAME: &str = "__si";
