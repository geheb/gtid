// scope: ui — CSRF extractor used only by UI handlers (forms + session cookies)
...
pub fn verify_csrf(cookies: &Cookies, submitted_token: &str) -> bool {
    ...
    crypto::constant_time::constant_time_eq(expected.as_bytes(), submitted_token.as_bytes())
}
