...
pub const MAX_STATE: usize = 2048;
pub const MAX_ID_TOKEN_HINT: usize = 2048;
pub const MAX_NONCE: usize = 512;
pub const MIN_CODE_CHALLENGE: usize = 43;
pub const MAX_CODE_CHALLENGE: usize = 128;
